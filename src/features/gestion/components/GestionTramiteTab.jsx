    ...
    <div className="tab-layout todo-risk-layout">
      ...
      <article className="card inner-card">
        ...
        <div className={`form-grid ${isCleas ? 'five-columns' : 'four-columns'} compact-grid`}>
          ...
          <DataField disabled={processingLocked} label="Provee repuestos" onChange={(value) => updateCase((draft) => { draft.todoRisk.processing.partsSupplierText = value; })} value={todoRisk.processing.partsSupplierText || ''} />
