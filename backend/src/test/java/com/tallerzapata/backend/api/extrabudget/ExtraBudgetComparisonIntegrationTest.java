...
class ExtraBudgetComparisonIntegrationTest {
    ...
    void setUp() {
        ...
        jdbc.update("INSERT INTO casos (id, public_id, codigo_carpeta, numero_orden, tipo_tramite_id, organizacion_id, sucursal_id, referenciado, usuario_creador_id, estado_tramite_actual_id, estado_reparacion_actual_id, estado_pago_actual_id, estado_documentacion_actual_id, estado_legal_actual_id, prioridad_codigo) VALUES (100, '00000000-0000-0000-0000-000000003100', '0100PZ', 100, 1, 1, 1, false, 1, 1, 4, 7, 9, 11, 'MEDIA')");
