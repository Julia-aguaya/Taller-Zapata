...
ALTER TABLE repuestos_caso
    ...
    ADD KEY idx_repuestos_caso_presupuesto_extra_item (presupuesto_extra_item_id),
    ADD UNIQUE KEY uq_repuestos_caso_presupuesto_extra_item (caso_id, presupuesto_extra_item_id),
