...
INSERT IGNORE INTO marcas_vehiculo (id, codigo, nombre, activo) VALUES
    (9101, 'CHEVROLET', 'Chevrolet', 1),
    (9102, 'PEUGEOT', 'Peugeot', 1),
    (9103, 'VOLKSWAGEN', 'Volkswagen', 1);

INSERT IGNORE INTO modelos_vehiculo (id, marca_id, codigo, nombre, activo) VALUES
...
INSERT IGNORE INTO persona_contactos (id, persona_id, tipo_contacto_codigo, valor, principal, validado, observaciones) VALUES
...
INSERT IGNORE INTO persona_domicilios (id, persona_id, tipo_domicilio_codigo, calle, numero, piso, depto, localidad, provincia, codigo_postal, pais_codigo, principal) VALUES
...
INSERT IGNORE INTO vehiculo_personas (id, vehiculo_id, persona_id, rol_vehiculo_codigo, es_actual, desde, hasta, notas) VALUES
...
INSERT IGNORE INTO companias_seguro (id, public_id, codigo, nombre, cuit, requiere_fotos_reparado, dias_pago_esperados, activo) VALUES
...
INSERT IGNORE INTO companias_contactos (id, compania_id, persona_id, rol_contacto_codigo) VALUES
...
INSERT IGNORE INTO caso_personas (id, caso_id, persona_id, rol_caso_codigo, vehiculo_id, es_principal, notas) VALUES
...
INSERT IGNORE INTO caso_vehiculos (id, caso_id, vehiculo_id, rol_vehiculo_codigo, es_principal, orden_visual, notas) VALUES
...
INSERT IGNORE INTO caso_siniestro (id, caso_id, fecha_siniestro, hora_siniestro, lugar, dinamica, observaciones, fecha_prescripcion, dias_tramitando) VALUES
...
INSERT IGNORE INTO caso_estado_historial (id, caso_id, dominio_estado, estado_id, fecha_estado, usuario_id, automatico, motivo, detalle_json) VALUES
...
INSERT IGNORE INTO turnos_reparacion (
...
INSERT IGNORE INTO ingresos_vehiculo (
...
INSERT IGNORE INTO ingreso_items (id, ingreso_id, tipo_item_codigo, detalle, estado_codigo, referencia_media) VALUES
...
INSERT IGNORE INTO egresos_vehiculo (
...
INSERT IGNORE INTO presupuesto_items (
...
INSERT IGNORE INTO repuestos_caso (
...
INSERT IGNORE INTO documento_relaciones (id, documento_id, caso_id, entidad_tipo, entidad_id, modulo_codigo, principal, visible_cliente, orden_visual) VALUES
...
INSERT IGNORE INTO comprobantes_emitidos (
...
INSERT IGNORE INTO movimiento_retenciones (id, movimiento_id, tipo_retencion_codigo, monto, detalle) VALUES
...
INSERT IGNORE INTO movimiento_aplicaciones (id, movimiento_id, caso_id, concepto_codigo, entidad_tipo, entidad_id, monto_aplicado) VALUES
    (9891, 9871, 9401, 'MANO_OBRA', 'PRESUPUESTO', 9811, 544500.00),
    (9892, 9871, 9401, 'REPUESTO', 'PRESUPUESTO', 9811, 210000.00);

INSERT IGNORE INTO caso_seguro (
...
INSERT IGNORE INTO caso_tramitacion_seguro (
...
INSERT IGNORE INTO notificaciones (id, usuario_id, caso_id, tipo_codigo, titulo, mensaje, leida, leida_at, accion_url, entidad_tipo, entidad_id, created_at) VALUES
