...
public class BudgetComparisonSnapshotEntity {
    ...
    @Column(name = "presupuesto_id", nullable = false, updatable = false) private Long budgetId;
    @Column(name = "generacion", nullable = false, updatable = false) private Integer generation;
    @Column(name = "fecha_presupuesto", nullable = false, updatable = false) private LocalDate budgetDate;
    @Column(name = "version_presupuesto", nullable = false, updatable = false) private Integer budgetVersion;
