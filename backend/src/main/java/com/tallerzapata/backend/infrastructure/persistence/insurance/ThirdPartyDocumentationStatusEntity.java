...
@Entity
@Table(name = "estados_documentacion_terceros")
public class ThirdPartyDocumentationStatusEntity {
    ...
    public String getCode(){return code;} public String getName(){return name;} public Boolean getActive(){return active;}
}
