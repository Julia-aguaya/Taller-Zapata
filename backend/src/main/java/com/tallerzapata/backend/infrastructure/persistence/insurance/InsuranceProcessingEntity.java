...
public class InsuranceProcessingEntity {
    ...
    @Column(name = "no_repara", nullable = false) private Boolean noRepair = false;
    @Column(name = "admin_override_turno", nullable = false) private Boolean adminOverrideAppointment = false;
