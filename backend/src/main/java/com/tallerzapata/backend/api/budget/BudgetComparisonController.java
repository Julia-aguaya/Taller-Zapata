...
public class BudgetComparisonController {
    ...
    @GetMapping @PreAuthorize("hasAuthority('presupuesto.ver')") public List<Snapshot> list(@PathVariable Long caseId) { return service.list(caseId); }
    ...
    @PostMapping("/{snapshotId}/pieces/{pieceId}/providers/{columnId}/select") @PreAuthorize("hasAuthority('presupuesto.crear')") public CasePartResponse selectQuote(@PathVariable Long caseId,@PathVariable Long snapshotId,@PathVariable Long pieceId,@PathVariable Long columnId) { return service.selectQuote(caseId,snapshotId,pieceId,columnId); }
