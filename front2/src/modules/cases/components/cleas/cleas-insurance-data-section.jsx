...
export const CleasInsuranceDataSection = ({ values, onChange }) => (
  <Card className="rounded-3xl border-border/70 p-5">
    ...
    {/* Mové estos Field o cambiá md:grid-cols-2/gap para ajustar la composición exclusiva de CLEAS. */}
    <div className="mt-4 grid gap-x-6 gap-y-3 md:grid-cols-2">
      ...
      <Field label="N.º de CLEAS"><Input value={values.cleasNumber} onChange={onChange('cleasNumber')} /></Field>
