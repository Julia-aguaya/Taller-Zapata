...
export const CleasProcedureSection = ({ cleasOver, opinion, values, onChange }) => {
  const agreedAmount = toAmount(values.agreedAmount);
  ...
  return (
    <Card className="rounded-3xl border-border/70 p-5">
      ...
      {/* Campos comunes. Ajustá md:grid-cols-3, gap y orden solo para la experiencia CLEAS. */}
      ...
      {showFavorableAmounts ? (
        <div className="mt-5 rounded-2xl border border-primary/15 bg-primary/5 p-4">
          ...
          <div className="mt-3 grid gap-3 md:grid-cols-2">
            ...
            <Field label="Monto de cotización acordada"><Input type="number" min="0" value={values.agreedAmount} onChange={onChange('agreedAmount')} /></Field>
