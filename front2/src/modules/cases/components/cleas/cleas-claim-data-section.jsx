...
const emptyIncident = { incidentDate: '', incidentTime: '', location: '', dynamics: '', observations: '', prescriptionDate: '', thirdPartyPlate: '' };
...
export const CleasClaimDataSection = ({ caseId }) => {
  ...
  useEffect(() => {
    ...
    setDraft({ ...emptyIncident, ...incidentQuery.data.incident, thirdPartyPlate: incidentQuery.data.thirdPartyPlate ?? '' });
  }, [incidentQuery.data]);

  const mutation = useMutation({
    mutationFn: () => saveCleasIncident(caseId, { incident: { incidentDate: draft.incidentDate || null, incidentTime: draft.incidentTime || null, location: draft.location || null, dynamics: draft.dynamics || null, observations: draft.observations || null, prescriptionDate: draft.prescriptionDate || null }, thirdPartyPlate: draft.thirdPartyPlate || null }),
